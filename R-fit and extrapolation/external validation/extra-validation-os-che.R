...
###
dfsurv_pfs_ser<-read.csv("os_che_surv.csv")
dfsurv_pfs_ser<-dfsurv_pfs_ser[1:61,]
...
#test 12:39
###########################-----###
cal_df<-dfsurv_pfs_ser[18:61,]
cal_lthaz<-ltHaz0[18:61,]
cal_lthaz<-data.frame(Time=cal_lthaz$Time,Surv=cal_lthaz$surv)
...
ggsave(f_surv_mod1,width = 12,height = 8,dpi = 800,filename = "et_os_che.png",path = "C:/Users/Administrator/Desktop/斯鲁利单抗/external validation/os_che")
# ggsave(fig_MSE0_1,width = 12,height = 8,dpi = 800,filename = "pfs_ser_mse.png",path = "C:/Users/Administrator/Desktop/斯鲁利单抗/external validation/pfs_ser")
ggsave(fig_mse_1,width = 12,height = 8,dpi = 800,filename = "et_mse_os_che.png",path = "C:/Users/Administrator/Desktop/斯鲁利单抗/external validation/os_che")
res_mse=MSE
write.csv(res_mse,file = "C:/Users/Administrator/Desktop/斯鲁利单抗/external validation/os_che/MSE.csv",row.names=FALSE)
