...
###
dfsurv_pfs_ser<-read.csv("pfs_ser_surv.csv")
...
ggsave(f_surv_mod1,width = 12,height = 8,dpi = 800,filename = "et_pfs_ser.png",path = "C:/Users/Administrator/Desktop/斯鲁利单抗/external validation/pfs_ser")
...
ggsave(fig_mse_1,width = 12,height = 8,dpi = 800,filename = "et_mse_pfs_ser.png",path = "C:/Users/Administrator/Desktop/斯鲁利单抗/external validation/pfs_ser")
res_mse=rbind(MSE,MSE0)
write.csv(res_mse,file = "C:/Users/Administrator/Desktop/斯鲁利单抗/external validation/pfs_ser/MSE.csv",row.names=FALSE)
