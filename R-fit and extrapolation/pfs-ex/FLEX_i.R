...
modFP2_1 <- glm(cbind(Events,AtRisk-Events) ~ I(Time^(1)) + I(Time^1)*lnTime + offset(log(timedelta)), family=binomial(link=cloglog), data=ltHaz)
...
ggsave("fig_surv_ser_pfs_fit.png",f_surv2,width = 12,height = 8,dpi = 600)
